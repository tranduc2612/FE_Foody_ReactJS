...
function Navbar() {
    return ( <nav className="mx-auto max-w-7xl py-7">
        <div className="relative flex flex-col h-16 items-center justify-around">
            <div className="navbar__logo mr-4">
                <Link className="text-lg m-3 items-center flex font-semibold" to={'/home'}>
                    <img src="/src/assets/logo/brand.svg" alt="" />
                </Link>
            </div>
        
            <ul className="navbar__navigation-list flex">
                    <li className="navbar__navigation-item relative">
                        <Link className="active navbar__navigation-link text-base m-3 p-2 items-center flex font-semibold" to={'/home'}>
                    ...
                    <li className="navbar__navigation-item relative">
                        <Link className="navbar__navigation-link text-base m-3 p-2 items-center flex font-semibold" to={'/home'}>
